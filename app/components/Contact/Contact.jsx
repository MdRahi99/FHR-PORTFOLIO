    ...
    return (
        <div className="flex flex-col">
            ...
            <div className="grid lg:grid-cols-3 gap-12">
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 col-span-2 order-2 lg:order-1">
                ...
                <div className="space-y-8 col-span-1 order-1 lg:order-2">
                    ...
                    <div>
                        ...
                        <a href="mailto:mdforhadhossainrahi10@gmail.com" className="text-secondary hover:text-hover transition duration-300">
